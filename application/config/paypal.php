 ...
 */
$config['APIUsername'] = $config['Sandbox'] ? 'paulpritam911_api1.gmail.com' : 'PRODUCTION_USERNAME_GOES_HERE';
$config['APIPassword'] = $config['Sandbox'] ? '1396956962' : 'PRODUCTION_PASSWORD_GOES_HERE';
$config['APISignature'] = $config['Sandbox'] ? 'AiPC9BjkCyDFQXbSkoZcgqH3hpacA0DQr73PYNtYl48FHB2ACktL43ai' : 'PRODUCTION_SIGNATURE_GOES_HERE';
