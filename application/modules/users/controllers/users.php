...
class users extends MY_Controller {
   ...
   {   
        ...
        <div style="width:100%; margin:0 auto; border-bottom:1px solid #CCC;">
            ...
            <p>Welcome to our family.If you have any issues we will be happy to help you. You can contact us on <a href="mailto:sayan@xyz.com" style=" text-decoration:none; color:#0F70A8">xxx@xxx.com</a></p><br>
            <p>Sincerely,<br>
            Ecommerce Portal</p>
            <div style="font:0; line-height:0; clear:both;"></div>
            </div>
	...
	$data['userDetails']=$this->login->userDetail($userId);
